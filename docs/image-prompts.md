# Vanver character image prompts

Prompts and image rules for the Vanver character cards, written for ChatGPT image generation or any DALL·E / SDXL-class model.
...
```text
public/characters/<character-id>.webp
public/characters/<character-id>-2.webp
public/characters/<character-id>-3.webp
```
...
```text
public/characters/<character-id>-level-2-1.webp
public/characters/<character-id>-level-2-2.webp
public/characters/<character-id>-level-2-3.webp
public/characters/<character-id>-level-3-1.webp
public/characters/<character-id>-level-3-2.webp
public/characters/<character-id>-level-3-3.webp
```
...
| Character | File path |
| --- | --- |
| Chí Phèo | `public/characters/chi-pheo.webp` |
| Mị | `public/characters/mi-1.webp` |
| Xuân Tóc Đỏ | `public/characters/xuan-toc-do-1.webp` |
| Lục Vân Tiên | `public/characters/luc-van-tien.webp` |
| Thúy Kiều | `public/characters/thuy-kieu-1.webp` |
...
## 3. Xuân Tóc Đỏ — `xuan-toc-do-1.webp`
...
## 4. Lục Vân Tiên — `luc-van-tien.webp`
